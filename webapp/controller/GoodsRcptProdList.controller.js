sap.ui.define([
	...
	return BaseController.extend("dyflex.mm.s4cloud.warehouse.controller.GoodsRcptProdList", {
		 ...
		 * @memberOf dyflex.mm.s4cloud.warehouse.view.GoodsRcptProdList
		 */
		onInit: function () {
			
			var that = this;
			this._oTable = this.byId("idGoodsReceiptListTable");
			...
			this._oViewModel = new JSONModel({
				listTableTitle : this.getResourceBundle().getText("goodsReceiptListTableTitle"),
				saveAsTileTitle: this.getResourceBundle().getText("saveAsTileTitle", this.getResourceBundle().getText("goodsReceiptListTitle")),
		...
		onUpdateFinished : function (oEvent) {
			...
			if (iTotalItems && oTable.getBinding("items").isLengthFinal()) {
				sTitle = this.getResourceBundle().getText("goodsReceiptListTableTitleCount", [iTotalItems]);
			} else {
				sTitle = this.getResourceBundle().getText("goodsReceiptListTableTitle");
			}
		...
		onPress : function (oEvent) {
			...
			this.getRouter().navTo("goodsRcptProdDetail", {
