sap.ui.define([
	...
	return BaseController.extend("dyflex.mm.s4cloud.warehouse.controller.StockTransferList", {
		 ...
		 * @memberOf dyflex.mm.s4cloud.warehouse.view.StockTransferList
		 */
		onInit: function () {
			
			var that = this;
			this._oTable = this.byId("idStockTransferListTable");
			...
			this._oViewModel = new JSONModel({
				listTableTitle : this.getResourceBundle().getText("stockTransferListTableTitle"),
				saveAsTileTitle: this.getResourceBundle().getText("saveAsTileTitle", this.getResourceBundle().getText("stockTransferListTitle")),
		...
		onUpdateFinished : function (oEvent) {
			...
			if (iTotalItems && oTable.getBinding("items").isLengthFinal()) {
				sTitle = this.getResourceBundle().getText("stockTransferListTableTitleCount", [iTotalItems]);
			} else {
				sTitle = this.getResourceBundle().getText("stockTransferListTableTitle");
			}
		...
		onPress : function (oEvent) {
			...
			this.getRouter().navTo("stockTransferDetail", {
				objectId: oObject.ID
			});
		},
