...
sap.ui.define([
	...
	"dyflex/mm/s4cloud/warehouse/test/flpSandbox"
	...
	return Opa5.extend("dyflex.mm.s4cloud.warehouse.test.integration.arrangements.FLP", {
		/**
		...
		iRestartTheAppWithTheRememberedItem: function (oOptions) {
			this.waitFor({
				success: function () {
					...
					oOptions.hash = "A_MatlStkInAcctMod/" + encodeURIComponent(sObjectId);
