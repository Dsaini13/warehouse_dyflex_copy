sap.ui.define([
	"sap/ui/test/Opa5",
	"dyflex/mm/s4cloud/warehouse/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function (Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("dyflex.mm.s4cloud.warehouse.test.integration.arrangements.Startup", {
		...
		iStartMyApp: function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "dyflex.mm.s4cloud.warehouse",
					async: true
				},
				hash: oOptions.hash,
		...
		iRestartTheAppWithTheRememberedItem: function (oOptions) {
			this.waitFor({
				success: function () {
					...
					oOptions.hash = "A_MatlStkInAcctMod/" + sObjectId;
